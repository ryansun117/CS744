...
## see additional comments in part3_1.py
# for task 4, we reuse task 3 code and kill one worker at 25% and 75% of the program lifetime
...
if __name__ == "__main__":
  ...
  if TASK_NO == 1:
    ...
    ranks = links.map(lambda kv: (kv[0], 1.0))
  elif TASK_NO == 2:
